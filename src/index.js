define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-charts", "@syncfusion/ej2-navigations", "@syncfusion/ej2-notifications", "./datasource"], function (require, exports, ej2_base_1, ej2_charts_1, ej2_navigations_1, ej2_notifications_1, datasource_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.category = void 0;
    ej2_charts_1.AccumulationChart.Inject(ej2_charts_1.AccumulationSelection, ej2_charts_1.AccumulationLegend, ej2_charts_1.PieSeries, ej2_charts_1.AccumulationDataLabel, ej2_charts_1.AccumulationAnnotation, ej2_charts_1.AccumulationTooltip, ej2_charts_1.AccumulationSelection, ej2_charts_1.ChartAnnotation);
    ej2_charts_1.Chart.Inject(ej2_charts_1.Selection, ej2_charts_1.ColumnSeries, ej2_charts_1.Selection, ej2_charts_1.Zoom, ej2_charts_1.SplineSeries, ej2_charts_1.Category, ej2_charts_1.Legend, ej2_charts_1.Tooltip, ej2_charts_1.ChartAnnotation, ej2_charts_1.DateTime, ej2_charts_1.Crosshair, ej2_charts_1.PolarSeries);
    ej2_charts_1.Chart.Inject(ej2_charts_1.LineSeries, ej2_charts_1.AreaSeries, ej2_charts_1.SplineAreaSeries, ej2_charts_1.BubbleSeries, ej2_charts_1.DateTime, ej2_charts_1.Logarithmic, ej2_charts_1.Legend, ej2_charts_1.Tooltip, ej2_charts_1.StripLine);
    var linechartObj;
    var pieChartObj;
    var annotationpie1;
    var annotationpie2;
    ...
    function InitializeAppBar() {
        var appbarObj = new ej2_navigations_1.AppBar({
            cssClass: 'custom-appbar'
        });
        appbarObj.appendTo("#appbar");
    }
    function InitializeSkeleton() {
        var cards = document.querySelectorAll('#card-row .row .e-card');
        (0, ej2_base_1.addClass)([cards[0], cards[1], cards[2], cards[3]], "hidden-element-size");
        var calorieSkeleton = new ej2_notifications_1.Skeleton({
            width: '100%',
            height: cards[0].offsetHeight,
            shimmerEffect: 'Wave'
        });
        calorieSkeleton.appendTo('#calorie-skeleton');
        var stepSkeleton = new ej2_notifications_1.Skeleton({
            width: '100%',
            height: cards[1].offsetHeight,
            shimmerEffect: 'Wave'
        });
        stepSkeleton.appendTo('#steps-skeleton');
        var waterSkeleton = new ej2_notifications_1.Skeleton({
            width: '100%',
            height: cards[2].offsetHeight,
            shimmerEffect: 'Wave'
        });
        waterSkeleton.appendTo('#water-skeleton');
        var sleepSkeleton = new ej2_notifications_1.Skeleton({
            width: '100%',
            height: cards[3].offsetHeight,
            shimmerEffect: 'Wave'
        });
        sleepSkeleton.appendTo('#sleep-skeleton');
        var lineChartSkeleton = new ej2_notifications_1.Skeleton({
            width: '100%',
            height: '100%',
            shimmerEffect: 'Wave'
        });
        (0, ej2_base_1.removeClass)([cards[0], cards[1], cards[2], cards[3]], "hidden-element-size");
        lineChartSkeleton.appendTo('#line-chart-skeleton');
        var pieChartSkeleton = new ej2_notifications_1.Skeleton({
            width: '100%',
            height: '100%',
            shimmerEffect: 'Wave'
        });
    ...
    function LoadCardData() {
        GetCardData().then(function (data) {
            ...
            document.querySelectorAll('#card-row .row .card-skeleton').forEach(function (elem) { return elem.style.display = 'none'; });
            document.querySelectorAll('#card-row .row .e-card').forEach(function (elem) { return elem.style.display = 'flex'; });
    ...
    function LoadChartData(activity) {
    ...
    function ToggleVisibility(displaySkeleton, displayChart) {
        document.getElementById('line-chart-skeleton').style.display = displaySkeleton;
        document.getElementById('pie-chart-skeleton').style.display = displaySkeleton;
        document.getElementById('line').style.display = displayChart;
        document.getElementById('pie-wrapper').style.display = displayChart;
    }
    ...
    function InitializeCaloriesComponent() {
        var pointMove = function (args) {
            var point = (0, ej2_charts_1.getElement)(linechartObj.element.id + '_Series_' + args.seriesIndex + '_Point_' + args.pointIndex + '_Symbol');
            if (point) {
        ...
        var mouseclick = function (args) {
            ...
            if ((0, ej2_charts_1.getElement)(linechartObj.element.id + '_Series_' + index.series + '_Point_' + index.point + '_Symbol')) {
                switch (index.point) {
                    case 0:
                        pieChartObj.series[0].dataSource = datasource_1.Sunday[0].Calories;
                        ...
                        break;
                    case 1:
                        pieChartObj.series[0].dataSource = datasource_1.Monday[0].Calories;
                        ...
                        break;
                    case 2:
                        pieChartObj.series[0].dataSource = datasource_1.Tuesday[0].Calories;
                        ...
                        break;
                    case 3:
                        pieChartObj.series[0].dataSource = datasource_1.Wednesday[0].Calories;
                        ...
                        break;
                    case 4:
                        pieChartObj.series[0].dataSource = datasource_1.Thursday[0].Calories;
                        ...
                        break;
                    case 5:
                        pieChartObj.series[0].dataSource = datasource_1.Friday[0].Calories;
                        ...
                        break;
                    case 6:
                        pieChartObj.series[0].dataSource = datasource_1.Saturday[0].Calories;
        ...
        var pointClick = function (args) {
            var index = (0, ej2_charts_1.indexFinder)(args.target);
            if ((0, ej2_charts_1.getElement)(linechartObj.element.id + '_Series_' + index.series + '_Point_' + index.point)) {
                switch (index.point) {
                    case 0:
                        pieChartObj.series[0].dataSource = datasource_1.Sunday[0].Breakfast;
                        break;
                    case 1:
                        pieChartObj.series[0].dataSource = datasource_1.Monday[0].Lunch;
                        break;
                    case 2:
                        pieChartObj.series[0].dataSource = datasource_1.Tuesday[0].Dinner;
                        break;
                    case 3:
                        pieChartObj.series[0].dataSource = datasource_1.Wednesday[0].Snack;
                        break;
                }
                pieChartObj.appendTo('#account-balance');
                pieChartObj.refresh();
        ...
        pieChartObj = new ej2_charts_1.AccumulationChart({
            series: [
                {
        ...
        linechartObj = new ej2_charts_1.Chart({
            ...
            loaded: function (args) {
                ...
                document.getElementById("Lunch-icon").onclick = function () {
                    ...
                    pieChartObj.series[0].dataSource = datasource_1.Sunday[0].Lunch;
                };
                document.getElementById("Dinner-icon").onclick = function () {
                    ...
                    pieChartObj.series[0].dataSource = datasource_1.Sunday[0].Dinner;
                };
                document.getElementById("Snack-icon").onclick = function () {
                    ...
                    document.getElementById("vitamins_value").innerHTML = '60g';
                    pieChartObj.series[0].dataSource = datasource_1.Sunday[0].Snack;
                };
            }
        });
    ...
    function InitializeStepsComponent() {
        var annotationpie1data = datasource_1.Sunday[0].Exercise;
        var annotationpie2data = datasource_1.Sunday[0].Hours;
        var pointMove = function (args) {
            var point = (0, ej2_charts_1.getElement)(linechartObj.element.id + '_Series_' + args.seriesIndex + '_Point_' + args.pointIndex);
            if (point) {
                point.setAttribute('cursor', 'pointer');
            }
        };
        var mouseclick = function (args) {
            ...
            if ((0, ej2_charts_1.getElement)(linechartObj.element.id + '_Series_' + index.series + '_Point_' + index.point)) {
                switch (index.point) {
                    case 0:
                        pieChartObj.series[0].dataSource = datasource_1.Sunday[0].Steps;
                        document.querySelector('#multiple-donut #pie-title').innerHTML = 'Sunday Activity';
                        ...
                        annotationpie1data = datasource_1.Sunday[0].Exercise;
                        annotationpie2data = datasource_1.Sunday[0].Hours;
                        break;
                    case 1:
                        pieChartObj.series[0].dataSource = datasource_1.Monday[0].Steps;
                        ...
                        annotationpie1data = datasource_1.Monday[0].Exercise;
                        annotationpie2data = datasource_1.Monday[0].Hours;
                        break;
                    case 2:
                        pieChartObj.series[0].dataSource = datasource_1.Tuesday[0].Steps;
                        ...
                        annotationpie1data = datasource_1.Tuesday[0].Exercise;
                        annotationpie2data = datasource_1.Tuesday[0].Hours;
                        break;
                    case 3:
                        pieChartObj.series[0].dataSource = datasource_1.Wednesday[0].Steps;
                        ...
                        annotationpie1data = datasource_1.Wednesday[0].Exercise;
                        annotationpie2data = datasource_1.Wednesday[0].Hours;
                        break;
                    case 4:
                        pieChartObj.series[0].dataSource = datasource_1.Thursday[0].Steps;
                        ...
                        annotationpie1data = datasource_1.Thursday[0].Exercise;
                        annotationpie2data = datasource_1.Thursday[0].Hours;
                        break;
                    case 5:
                        pieChartObj.series[0].dataSource = datasource_1.Friday[0].Steps;
                        ...
                        annotationpie1data = datasource_1.Friday[0].Exercise;
                        annotationpie2data = datasource_1.Friday[0].Hours;
                        break;
                    case 6:
                        pieChartObj.series[0].dataSource = datasource_1.Saturday[0].Steps;
                        ...
                        document.getElementById("active").innerHTML = '4';
                        pieChartObj.annotations[0].content = '<div id="steps-innercontent"><p id="main-value" style="font-family: Roboto; font-weight:500; font-size: 28px;color: #313331;letter-spacing: 0;text-align: center; margin:0px">1300</p><p id="step-value" style="font-family: Roboto;font-weight:500; font-size: 14px; color: #535353; letter-spacing: 0;text-align: center;">Calories burnt<p></div>';
                        annotationpie1data = datasource_1.Saturday[0].Exercise;
                        annotationpie2data = datasource_1.Saturday[0].Hours;
                        break;
                }
        ...
        pieChartObj = new ej2_charts_1.AccumulationChart({
            ...
            loaded: function (args) {
                annotationpie1 = new ej2_charts_1.AccumulationChart({
                    series: [
                        {
                ...
                annotationpie2 = new ej2_charts_1.AccumulationChart({
                    series: [
                        {
        ...
        linechartObj = new ej2_charts_1.Chart({
            ...
            annotations: [{
                    content: '<div id="thumbs_up"><img src="/src/icons/Shape.png"  style="width: 30px; height: 30px"/></div>',
    ...
    function InitializeSleepComponent() {
        var pointMove = function (args) {
            var point = (0, ej2_charts_1.getElement)(linechartObj.element.id + '_Series_' + args.seriesIndex + '_Point_' + args.pointIndex);
            if (point) {
                point.setAttribute('cursor', 'pointer');
        ...
        var mouseclick = function (args) {
            ...
            if ((0, ej2_charts_1.getElement)(linechartObj.element.id + '_Series_' + index.series + '_Point_' + index.point)) {
                switch (index.point) {
                    case 0:
                        pieChartObj.series[0].dataSource = datasource_1.Sunday[0].sleep;
                        pieChartObj.loaded = function (args) {
                        ...
                        break;
                    case 1:
                        pieChartObj.series[0].dataSource = datasource_1.Monday[0].sleep;
                        pieChartObj.loaded = function (args) {
                        ...
                        break;
                    case 2:
                        pieChartObj.series[0].dataSource = datasource_1.Tuesday[0].sleep;
                        pieChartObj.loaded = function (args) {
                        ...
                        break;
                    case 3:
                        pieChartObj.series[0].dataSource = datasource_1.Wednesday[0].sleep;
                        pieChartObj.loaded = function (args) {
                            document.getElementById("leftcontent").innerHTML = '10:30 pm';
                        ...
                        break;
                    case 4:
                        pieChartObj.series[0].dataSource = datasource_1.Thursday[0].sleep;
                        pieChartObj.loaded = function (args) {
                        ...
                        break;
                    case 5:
                        pieChartObj.series[0].dataSource = datasource_1.Friday[0].sleep;
                        pieChartObj.loaded = function (args) {
                            document.getElementById("leftcontent").innerHTML = '11:40 pm';
                        ...
                        break;
                    case 6:
                        pieChartObj.series[0].dataSource = datasource_1.Saturday[0].sleep;
                        pieChartObj.loaded = function (args) {
    ...
    function InitializeWaterComponent() {
        var pointindex = 5;
        var pointMove = function (args) {
            var point = (0, ej2_charts_1.getElement)(linechartObj.element.id + '_Series_' + args.seriesIndex + '_Point_' + args.pointIndex + '_Symbol');
            if (point) {
        ...
        var piepointMove = function (args) {
            var point = (0, ej2_charts_1.getElement)(pieChartObj.element.id + '_Series_' + args.seriesIndex + '_Point_' + args.pointIndex);
            if (point) {
                point.setAttribute('cursor', 'pointer');
            }
        };
        var pointclick = function (args) {
            ...
            if ((0, ej2_charts_1.getElement)(polarChartObj.element.id + '_Series_' + args.seriesIndex + '_Point_' + args.pointIndex)) {
        ...
        var mouseclick = function (args) {
            selectedpoint = false;
            if (!(0, ej2_charts_1.getElement)(linechartObj.element.id + '_Series_' + args.seriesIndex + '_Point_' + args.pointIndex)) {
                switch (args.pointIndex) {
                    case 0:
                        polarChartObj.series[0].dataSource = datasource_1.Sunday[0].water;
                        document.querySelector('#polar #pie-title').innerHTML = 'Sunday Activity';
                        break;
                    case 1:
                        polarChartObj.series[0].dataSource = datasource_1.Monday[0].water;
                        document.querySelector('#polar #pie-title').innerHTML = 'Monday Activity';
                        break;
                    case 2:
                        polarChartObj.series[0].dataSource = datasource_1.Tuesday[0].water;
                        document.querySelector('#polar #pie-title').innerHTML = 'Tuesday Activity';
                        break;
                    case 3:
                        polarChartObj.series[0].dataSource = datasource_1.Wednesday[0].water;
                        document.querySelector('#polar #pie-title').innerHTML = 'Wednesday Activity';
                        break;
                    case 4:
                        polarChartObj.series[0].dataSource = datasource_1.Thursday[0].water;
                        document.querySelector('#polar #pie-title').innerHTML = 'Thursday Activity';
                        break;
                    case 5:
                        polarChartObj.series[0].dataSource = datasource_1.Friday[0].water;
                        document.querySelector('#polar #pie-title').innerHTML = 'Friday Activity';
                        break;
                    case 6:
                        polarChartObj.series[0].dataSource = datasource_1.Saturday[0].water;
        ...
        var polarChartObj = new ej2_charts_1.Chart({
            primaryXAxis: {
                valueType: 'Category',
